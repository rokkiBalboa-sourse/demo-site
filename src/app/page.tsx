...
import { Network, Terminal, ShieldAlert, Cpu, BookOpen, Layers } from "lucide-react";
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-6">
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <CommandBlock command="echo '172.16.1.1/28' > /etc/net/ifaces/enp7s2/ipv4address" />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">4. Назначение IP-адреса на интерфейс enp7s3 (сеть к филиалу):</div>
                          <CommandBlock command="echo '172.16.2.1/28' > /etc/net/ifaces/enp7s3/ipv4address" />
                        </div>
                        <div>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          ...
                          <CommandBlock command="echo '172.16.2.2/28' > /etc/net/ifaces/enp7s1/ipv4address" />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">4. Настройка шлюза по умолчанию через ISP:</div>
                          <CommandBlock command="echo 'default via 172.16.2.1' > /etc/net/ifaces/enp7s1/ipv4route" />
                        </div>
                        <div>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">1. Создание директорий для интерфейсов enp7s1, enp7s2, vlan100, vlan200, vlan999 и gre1:</div>
                          <CommandBlock command="mkdir -p /etc/net/ifaces/{enp7s{1,2},vlan{100,200,999},gre1}" />
                        </div>
                        <div>
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">6. Генерация файлов настроек для vlan100, vlan200 и vlan999 на интерфейсе enp7s2:</div>
                          <CommandBlock command={'echo $\'100\\n200\\n999\' | xargs -i bash -c \'echo -e "TYPE=vlan\\nHOST=enp7s2\\nVID={}" > /etc/net/ifaces/vlan{}/options\''} />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">7. Проверка конфигурации vlan999 для контроля корректности параметров:</div>
                          <CommandBlock command="cat /etc/net/ifaces/vlan999/options" />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">8. Назначение IP-адреса для VLAN 100 (сеть серверов):</div>
                          <CommandBlock command="echo '192.168.100.1/27' > /etc/net/ifaces/vlan100/ipv4address" />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">9. Назначение IP-адреса для VLAN 200 (сеть клиентов):</div>
                          <CommandBlock command="echo '192.168.200.1/24' > /etc/net/ifaces/vlan200/ipv4address" />
                        </div>
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">10. Назначение IP-адреса для VLAN 999 (сеть управления):</div>
                          <CommandBlock command="echo '192.168.99.1/29' > /etc/net/ifaces/vlan999/ipv4address" />
                        </div>
                        <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">1. Создание пользователя sshuser с UID 2026:</div>
                          <CommandBlock command="useradd -u 2026 sshuser" />
                        </div>
                        <div>
                  ...
                  <div className="space-y-6">
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="text-sm text-zinc-300 space-y-2 leading-relaxed pt-2">
                        <p>4. В открывшемся окне параметров найдите поле <strong className="text-zinc-100">VLAN Tag</strong> и укажите значение <code className="text-emerald-400 font-mono text-xs bg-zinc-900/80 px-1.5 py-0.5 rounded border border-zinc-800/80">100</code>.</p>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="text-sm text-zinc-300 space-y-2 leading-relaxed">
                        ...
                        <p>3. Выполните аналогичные шаги редактирования сетевых настроек, но укажите значение <strong className="text-zinc-100">VLAN Tag</strong> равным <code className="text-emerald-400 font-mono text-xs bg-zinc-900/80 px-1.5 py-0.5 rounded border border-zinc-800/80">200</code>.</p>
...
Banner /etc/openssh/ssh_banner`}
                        ...
                        <div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-xl space-y-2 text-sm text-zinc-300">
                          ...
                          <CommandBlock command="ssh -p 2026 sshuser@192.168.100.2" />
...
Banner /etc/openssh/ssh_banner`}
                        ...
                        <div className="p-4 bg-emerald-500/5 border border-emerald-500/10 rounded-xl space-y-2 text-sm text-zinc-300">
                          ...
                          <CommandBlock command="ssh -p 2026 sshuser@192.168.0.2" />
                          <p>После проверки авторизации выйдите из удаленной сессии:</p>
                          <CommandBlock command="exit" />
                        </div>
                      </div>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="p-4 bg-[#0d0e12]/30 border border-zinc-800/40 rounded-xl space-y-2 text-sm text-zinc-300 leading-relaxed">
                          ...
                          <p>Впишите в файл следующие строки для настройки OSPF:</p>
                          <pre className="p-4 rounded-lg bg-[#050608] border border-zinc-800/60 text-zinc-200 font-mono text-xs leading-relaxed overflow-x-auto select-all my-2">
{`interface gre
 no ip ospf passive
exit
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">3. Создание конфигурации DNS-резолвера для интерфейса vlan100:</div>
          ...
          <AccordionItem title="Модуль 2: Инфраструктурные службы и службы каталогов" level={1}>
            <div className="space-y-4 mt-2">
              ...
              <AccordionItem title="Задание 2. Сконфигурируйте файловое хранилище на HQ-SRV" level={2}>
                <div className="space-y-4">
                  <p className="text-sm text-zinc-300 leading-relaxed">
                    Для создания производительного и надежного хранилища данных на сервере <code className="text-emerald-400 font-mono text-xs bg-zinc-900/80 px-1.5 py-0.5 rounded border border-zinc-800/80">HQ-SRV</code> настраивается программный RAID-массив уровня 0 (Striping) из нескольких доступных дисков, форматируется в файловую систему ext4 и монтируется в систему с настройкой автоматического подключения.
                  </p>
...
sdd 8:48 0 1G 0 disk`}
                        ...
                        <div className="p-4 bg-[#0d0e12]/30 border border-zinc-800/40 rounded-xl space-y-2 text-sm text-zinc-300">
                          ...
                          <div className="text-xs text-zinc-400 leading-relaxed mt-2 space-y-2">
                            ...
                            <pre className="p-3 rounded-lg bg-[#050608] border border-zinc-800/60 text-zinc-300 font-mono text-xs overflow-x-auto">
{`mklabel msdos
...
quit`}
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">3. Создание программного RAID-0 массива (md0) из двух размеченных разделов:</div>
                          <CommandBlock command="mdadm --create /dev/md0 --level=0 --raid-devices=2 /dev/sdb1 /dev/sdc1" />
                        </div>
                        ...
                        <div>
                          ...
                          <CommandBlock command="mdadm --detail --scan >> /etc/mdadm.conf" />
                        </div>

                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">5. Проверка текущей конфигурации RAID-массива в системе:</div>
                          <CommandBlock command="mdadm --detail --scan" />
                        </div>
                        ...
                        <div>
                          ...
                          <CommandBlock command='echo "/dev/md0 /raid ext4 defaults 0 0 " >> /etc/fstab' />
                        </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">3. Активация локального stratum 5 для работы без внешнего интернета:</div>
                          <CommandBlock command={'sed -i \'s/\\#local stratum 10/local stratum 5/\' /etc/chrony.conf | grep "local stratum" /etc/chrony.conf'} />
                        </div>
                    ...
                    <div className="border border-zinc-800/40 bg-zinc-950/10 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-6 text-sm text-zinc-300">
                        ...
                        <div className="p-4 bg-[#0d0e12]/30 border border-zinc-800/40 rounded-xl space-y-4">
                          ...
                          <p>Откройте веб-браузер и перейдите по IP-адресу сервера на порт 8080: <code className="text-zinc-200 bg-zinc-900/60 px-1.5 py-0.5 rounded border border-zinc-800/80 font-mono text-xs">http://192.168.3.10:8080/</code></p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">2. Проброс SSH-порта 2026 на внутренний сервер HQ-SRV:</div>
                          <CommandBlock command='nft add rule nat prerouting iif "enp7s1" tcp dport 2026 dnat to 192.168.1.10' />
                        </div>

                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">3. Проброс веб-порта 8080 на внутренний веб-сервер HQ-SRV (порт 80):</div>
                          <CommandBlock command='nft add rule nat prerouting iif "enp7s1" tcp dport 8080 dnat to 192.168.1.10:80' />
                        </div>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">2. Проброс портов 8080 (веб) и 2026 (SSH) на внутренний сервер BR-SRV (192.168.3.10):</div>
                          <CommandBlock command='nft add rule nat prerouting iif "enp7s1" tcp dport { 8080, 2026 } dnat to 192.168.3.10' />
                        </div>
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        <div>
                          ...
                          <CommandBlock command="apt-get update && apt-get install nginx -y" />
                        </div>

                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">2. Открытие нового конфигурационного файла виртуального хоста в редакторе vim:</div>
                          <CommandBlock command="vim /etc/nginx/sites-available.d/r-proxy.conf" />
                        </div>

                        <div className="p-4 bg-[#0d0e12]/30 border border-zinc-800/40 rounded-xl space-y-2 text-sm text-zinc-300 leading-relaxed">
                          <div className="font-semibold text-emerald-400">3. Редактирование конфигурации обратного прокси в vim:</div>
...
server {
  ...
  location / {
    ...
    proxy_set_header X-Forwarded-Proto $scheme;
                          ...
                          <p className="text-xs text-zinc-500 mt-1">Для начала редактирования нажмите клавишу <kbd className="px-1.5 py-0.5 bg-zinc-800 rounded border border-zinc-700 text-zinc-300 font-mono text-xs">i</kbd> (режим Insert). Убедитесь, что активна английская раскватка клавиатуры.</p>
                        </div>

                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">4. Сохранение конфигурации виртуального хоста и выход из vim:</div>
                          <p className="text-xs text-zinc-500 mb-1">Нажмите клавишу <kbd className="px-1.5 py-0.5 bg-zinc-800 rounded border border-zinc-700 text-zinc-300 font-mono text-xs">Esc</kbd>, введите команду ниже и нажмите <kbd className="px-1.5 py-0.5 bg-zinc-800 rounded border border-zinc-700 text-zinc-300 font-mono text-xs">Enter</kbd>:</p>
                          <CommandBlock command=":wq" />
                        </div>
                      </div>
              ...
              <AccordionItem title="Задание 10. На маршрутизаторе ISP настройте web-based аутентификацию" level={2}>
                <div className="space-y-4">
                  <p className="text-sm text-zinc-300 leading-relaxed">
                    Для ограничения неавторизованного доступа к внутреннему веб-ресурсу на пограничном маршрутизаторе <code className="text-emerald-400 font-mono text-xs bg-zinc-900/80 px-1.5 py-0.5 rounded border border-zinc-800/80">ISP</code> настраивается базовая HTTP-аутентификация (Basic Auth). Создается символическая ссылка для активации виртуального хоста, генерируется хэш пароля пользователя <code className="text-zinc-200 bg-zinc-900/60 px-1.5 py-0.5 rounded border border-zinc-800/80 font-mono text-xs">WEBc</code> в файле htpasswd и перезапускается служба Nginx.
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="border border-zinc-800/40 bg-[#0d0e12]/30 p-6 rounded-xl space-y-4">
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="text-xs text-zinc-400 font-semibold mb-1">6. Создание файла паролей и добавление пользователя WEBc:</div>
                          <CommandBlock command="htpasswd -c /etc/nginx/.htpasswd WEBc" />
                      ...
                      <div className="space-y-6 text-sm text-zinc-300">
                        ...
                        <div className="p-4 bg-[#0d0e12]/30 border border-zinc-800/40 rounded-xl space-y-4">
                          ...
                          <ul className="list-disc pl-5 text-xs text-zinc-400 space-y-1">
                            <li>Логин: <code className="text-zinc-200 font-mono text-xs">WEBc</code></li>
